...
export default function Cookies() {
  ...
  useEffect(() => {
    // Fetch the cookie policy content from the assets folder
    fetch('/assets/Cookie Policy SV Website.txt')
      ...
      .then(content => {
        ...
        setCookieContent(cleanedContent);
        setLoading(false);
      })
      .catch(error => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-white text-lg">Loading Cookie Policy...</div>
      </div>
    );
  }
