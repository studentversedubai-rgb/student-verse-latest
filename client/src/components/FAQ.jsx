...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "StudentVerse is completely free! As an exclusive early-access deal, the first 5,000 students receive StudentVerse Pro for free, with the chance to unlock one full year at no cost by referring 5 friends. After that, students can earn one month of Pro by completing 5 referrals before the waitlist closes, unlocking extra perks and exclusive features. A Pro+ plan is also available for even more benefits.",
      color: "#cc8800" // Orange/Yellow
    },
    {
      id: 3,
      question: "Who can join StudentVerse?",
      answer: "StudentVerse is designed for university students, allowing them to verify their student status and unlock exclusive discounts. Support for school students aged 15 and above is coming soon.",
      color: "#9a1f5a" // Purple/Pink
    },
    {
      id: 4,
      question: "When will StudentVerse be available?",
      answer: "Launching spring 2026 with a viral waitlist and MVP app featuring manual redemptions, before full automation later in the year.",
    ...
    <div style={{ padding: "0", margin: "0" }}>
      <div className="container">
        <div style={{ padding: "0", margin: "0" }}>
          ...
          <div id="faq-about" style={{ paddingTop: "0", marginTop: "0" }}>
            <div style={{ padding: "0", margin: "0" }}>
              <div className="container">
