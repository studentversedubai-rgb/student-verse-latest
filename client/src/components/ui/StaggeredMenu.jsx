  ...
  return (
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="Main navigation header">
        <a className="sm-logo" aria-label="StudentVerse home" href="/">
          <img src={logoUrl || '/assets/svlogo.png'} alt="StudentVerse Logo" className="sm-logo-img" draggable={false} width={110} height={24} />
        </a>
        <button
          ref={toggleBtnRef}
          className="sm-toggle"
        ...
        >
          <span ref={textWrapRef} className="sm-toggle-textWrap" aria-hidden="true">
            <span ref={textInnerRef} className="sm-toggle-textInner">
              {textLines.map((line, i) => (
                <span className="sm-toggle-line" key={i}>{line}</span>
              ))}
            </span>
          </span>
          <span ref={iconRef} className="sm-icon" aria-hidden="true">
            ...
            <span className="sm-icon-line sm-icon-line-b" />
          </span>
        </button>
      </header>
            ...
            {items && items.length ? (
              items.map((item, idx) => (
                <li className="sm-panel-itemWrap" key={item.label + idx}>
                  <a className="sm-panel-item" href={item.link} aria-label={item.ariaLabel} data-index={idx + 1} onClick={closeMenu}>
